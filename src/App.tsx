...
const  App = (props:any) =>{  
  ...
  const openMenu = () => {
    ...
    if(hoverInv.length > 0){
      ...
      document.getElementById('languageChange')!.style.transform = 'translate(100%, 5%)'
  ...
  return (
    <div className ="d-flex bd-highlight">
      ...
      <div className="menumobile" onClick={openMenu} id="menumobile">
        <i className="material-icons" style={{verticalAlign:'top',fontSize:'48px'}}>menu</i>
      </div>
      <div className="closemobile" id="closemobile" onClick={closeMenu}>
        <i className="material-icons" style={{verticalAlign:'top',fontSize:'48px'}}>navigate_before</i>
      </div>
